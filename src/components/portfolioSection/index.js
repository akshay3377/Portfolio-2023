...
const PortfolioSection = () => {
  return (
    <section className="w-[100%] pt-[150px] bg-grey">
        ...
        <div className="flex flex-col  ">
          {PORTFOLIO.map((portfolio, index) => {
            return (
              <div
                key={index}
                className=" max-w-[850px] shadow-xl rounded-[6px] py-[12px] px-[18px] mb-[86px] mx-auto "
              >
                <Image
                ...
                <a
                  href={portfolio.link}
                  target="_blank"
                  className=" inline-block my-[12px] text-[blue] underline  font-[700] text-[16px] "
                >
                  {portfolio.title}
                </a>
              </div>
